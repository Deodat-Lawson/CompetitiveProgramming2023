...
public class myCalender2 {
  ...
  public static void solve() throws IOException {
    MyCalendarTwo thisC = new MyCalendarTwo();

    System.out.println(thisC.book(47,50));
    System.out.println(thisC.book(1,10));
    System.out.println(thisC.book(27,36));
    System.out.println(thisC.book(40,47));
    System.out.println(thisC.book(20,27));
    System.out.println(thisC.book(15,23));
    System.out.println(thisC.book(10,18));
    System.out.println(thisC.book(27,36));
    System.out.println(thisC.book(17,25));
  }
  ...
  static class MyCalendarTwo {
    ...
    public boolean book(int start, int end) {
      if(thisTree.query(start, end - 1) < 2){
